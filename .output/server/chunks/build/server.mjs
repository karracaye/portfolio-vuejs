import { version, unref, inject, defineComponent, h, computed, ref, provide, shallowReactive, watch, Suspense, nextTick, Transition, hasInjectionContext, resolveComponent, mergeProps, useSSRContext, createApp, effectScope, reactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, getCurrentInstance, shallowRef, isReadonly, withCtx, createTextVNode, isRef, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch, m as defu, n as hasProtocol, o as joinURL, p as parseURL, q as parseQuery, r as createHooks, i as createError$1, w as withQuery, t as isScriptProtocol, v as withTrailingSlash, x as withoutTrailingSlash, y as sanitizeStatusCode, z as isSamePath, A as toRouteMatcher, B as createRouter$1 } from '../runtime.mjs';
...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./moredetails-BEDvcZg6.mjs').then((m) => m.default || m)
  },
  {
    name: "portfolio",
    path: "/portfolio",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-ChCrHIKA.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, __nuxt_component_0 as a, _imports_0 as b, entry$1 as default, injectHead as i, resolveUnrefHeadInput as r };

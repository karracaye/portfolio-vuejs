import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, shallowReactive, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, computed, ref, resolveComponent, provide, Suspense, nextTick, mergeProps, Transition, watch, withCtx, createTextVNode, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/benea-CF-UlAmO.js").then((m) => m.default || m)
  },
  {
    name: "document",
    path: "/document",
    ...
    component: () => import("./_nuxt/document-CMKR0k5m.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index-DRbiY0EK.js").then((m) => m.default || m)
  },
  {
    name: "innovex",
    path: "/innovex",
    ...
    component: () => import("./_nuxt/innovex-DVWGNvC4.js").then((m) => m.default || m)
  },
  {
    name: "inquiry",
    path: "/inquiry",
    ...
    component: () => import("./_nuxt/inquiry-9pt7VjDx.js").then((m) => m.default || m)
  },
  {
    name: "jci",
    path: "/jci",
    ...
    component: () => import("./_nuxt/jci-CXnT6sMU.js").then((m) => m.default || m)
  },
  {
    name: "moredetails",
    path: "/moredetails",
    ...
    component: () => import("./_nuxt/moredetails-BEDvcZg6.js").then((m) => m.default || m)
  },
  {
    name: "portfolio",
    path: "/portfolio",
    ...
    component: () => import("./_nuxt/portfolio-QV0Kp8JG.js").then((m) => m.default || m)
  },
  {
    name: "seeall",
    path: "/seeall",
    ...
    component: () => import("./_nuxt/seeall-BG1ciggh.js").then((m) => m.default || m)
  }
];
...
const _imports_0 = "" + __buildAssetsURL("K.4zf_H-Qg.png");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  if (_ctx.$route.path === "/") {
    _push(`<div class="h-screen w-screen absolute main-image"></div>`);
  } else {
    _push(`<!---->`);
  }
  ...
  _push(`</li><li>`);
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/seeall" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`WORK`);
      } else {
  ...
  _push(`</li></ul></nav></div></header><div class="font-jakartSans w-screen h-max">`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-ChCrHIKA.js").then((r) => r.default || r));
